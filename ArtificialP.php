...
$tanaman = $conn->query("SELECT * FROM tanaman where jenis='Artificial Plants'")->fetch_all(MYSQLI_ASSOC);
...
if (isset($_GET["page"])) {
  $_SESSION["page"] = 1;
  header("Location:ArtificialP.php");
}
...
if (isset($_POST["submit"])) {
  ...
  $nama = $_POST["search"];
  try {
    $tanaman = $conn->query("SELECT * FROM tanaman where jenis='Artificial Plants' and nama LIKE '%$nama%'")->fetch_all(MYSQLI_ASSOC);
...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light pb-2" id="nav">
        <div class="container" >
            ...
            <div class="navbar-nav ms-1 ">
                <a class="nav-link ms-1 active" href="ArtificialP.php">Artificial Plants</a>
                <a class="nav-link ms-1 " href="ArtificialFSearch.php?page=1">Artificial Flowers</a>
            </div>
    ...
    <div class="container">
        <div class="list">
            <div class="title">
                <h5>Fake Plants and Stems</h5>
                <p>Fake plants last forever and offer the lush look of nature without the hassle. From artificial plants that hang to outdoor artificial grasses and plants. Afloral has a premium selection of artificial plants and stems for your home decor. Learn why fake plants are so popular.</p>
            </div>
